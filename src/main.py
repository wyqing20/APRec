...
def main():
    ...
    phases_real=['train', 'dev', 'dev']
    if hasattr(model,'stage') and model.stage!=1:
        phases_real=['cold_train', 'cold_dev', 'cold_test']
...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--RATE', type=float, default=1.0, help='RATE of replace')
    ...
    log_args = [init_args.model_name, args.dataset,str(args.random_seed),"RATE="+str(args.RATE)]
