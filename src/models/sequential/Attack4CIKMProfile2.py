...
CMD example:
    for the fine-tuning:
       python main2.py --model_name Attack4CIKMProfile2 --emb_size 64 --num_layers 1 --num_heads 1 --lr 1e-4 --l2 1e-6 --history_max 100 \
...
class Attack4CIKMProfile2(SequentialModel):
    ...
    def __init__(self, args, corpus):
        ...
        self.pre_path = '/data/wuyq/APRec/model/Attack4CIKMProfile2/Pre__{}__encoder={}__w_prompt={}__max_history={}__RATE={}__num_layers{}__num_heads{}__emb_size{}__{}.pt'.format(corpus.dataset, self.encoder_name,self.w_prompt,
...
class PrefixGen(nn.Module):
    def __init__(self,emb_size,feature_encoder_name,encoder_layers=1,n_heads=None,n_layers=None):
        ...
        self.prefix_gen=nn.Sequential(
            nn.Linear(self.emb_size*1,self.emb_size*1),
            nn.ReLU(),
