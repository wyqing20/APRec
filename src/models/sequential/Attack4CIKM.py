...
""" 
CMD example:
       python main2.py --model_name Attack4CIKM --emb_size 64 --num_layers 1 --num_heads 1 --lr 1e-4 --l2 1e-6 --history_max 100 --dataset AttackCIKM --gpu 1 --stage 7 --test_all 1 --RATE -1 --w_prompt 0
...
class Attack4CIKM(SequentialModel):
    ...
    def __init__(self, args, corpus):
        ...
        self.pre_path = '/data/wuyq/APRec/model/Attack4CIKM/Pre__{}__encoder={}__w_prompt={}__max_history={}__RATE={}__num_layers{}__num_heads{}__emb_size{}__{}.pt'.format(corpus.dataset, self.encoder_name,self.w_prompt,
    ...
    def forward(self, feed_dict):
        ...
        if self.w_prompt>0 or self.stage==2 :
    ...
    class Dataset(SequentialModel.Dataset):
        ...
        def _get_feed_dict(self, index):
            ...
            if self.model.stage==1:
                ...
                if cate in self.model.selectedCate2item and 'test' not in self.phase:
