...
CMD example:
    ...
    python main2.py --model_name Attack4AliEC --emb_size 64 --num_layers 1 --num_heads 1 --lr 1e-4 --l2 1e-6 --history_max 100 --dataset 'AttackAliEC' --gpu 1 --stage 1 --test_all 1 --RATE 0.0
"""
...
class Attack4AliEC(SequentialModel):
    reader='AttackAliECReader'
    runner='AttackAliECRunner'
    extra_log_args = ['emb_size', 'num_layers', 'num_heads','f_encoder','stage','history_max','dropout','temp','cl_weight','w_feature']
    ...
    def __init__(self, args, corpus):
        ...
        self.pre_path = '/data/wuyq/APRec/model/Attack4AliEC/Pre__{}__encoder={}__w_feature={}__max_history={}__RATE={}__num_layers{}__num_heads{}__emb_size{}__{}.pt'.format(corpus.dataset, self.encoder_name,self.w_feature,
    ...
    class Dataset(SequentialModel.Dataset):
        ...
        def _get_feed_dict(self, index):
            ...
            if self.model.stage==1:
                ...
                if cate in self.model.selectedCate2item:
                    if cate in self.model.selectedCate2item:
                        random_num=random.random()
                    if random_num<=self.model.rate:
                        choice_item=random.choice(self.model.selectedCate2item[cate])
